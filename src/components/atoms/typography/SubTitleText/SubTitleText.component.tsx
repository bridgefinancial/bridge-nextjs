...
const SubTitleText: FC<SubTitleTextProps> = ({ children, className, sx = {}, fontWeight = '400', ...rest }) => {
  ...
  const mergedStyles = useMemo(() => merge({}, defaultStyles, sx, { fontWeight }), [sx, defaultStyles, fontWeight]);
