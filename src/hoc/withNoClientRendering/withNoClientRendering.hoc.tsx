 ...
 */
const withNoClientRendering = <P extends object>(WrappedComponent: React.ComponentType<P>) => {
  const ServerOnlyWrapper = (props: P) => {
    if (typeof window !== "undefined") {
      console.error("This component should not run on the client side.");
      throw new Error("Client-side features are being used in a server-side component.");
    }
