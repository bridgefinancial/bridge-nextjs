...
export const ValuationEstimate: React.FC<ValuationEstimateProps> = ({ industry = defaultIndustry }) => {
        ...
        <div className="gradient-border p-[2px]">
          <div className="bg-white py-10 px-10 flex flex-col items-center gap-8 rounded-[20px]">
            <div className="flex flex-col gap-4 text-center  ">
              <TitleText sx={{ fontSize: "30px", lineHeight: "40px", marginBottom: 0 }} component={"h1"}>
