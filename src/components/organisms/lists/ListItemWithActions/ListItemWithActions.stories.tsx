...
export const Default: Story = {
  args: {
    ...
    icon: <DocumentIcon fileName={'hello-seattle.pdf'} />,
  },
};
...
export const WithDownloadAction: Story = {
  args: {
    ...
    icon: <DocumentIcon fileName={'Invoice.pdf'} />,
  },
};
...
export const NoSubtitle: Story = {
  args: {
    ...
    icon: <DocumentIcon fileName={'wooooord.docx'} />,
  },
};
...
export const CustomStyled: Story = {
  args: {
    ...
    icon: <DocumentIcon fileName={'my-secret-files.csv'} />,
    sx: {
...
export const MobileView: Story = {
  args: {
    ...
    icon: <DocumentIcon fileName={'hello-world-101.pdf'} />,
...
export const DisabledActions: Story = {
  args: {
    ...
    icon: <DocumentIcon fileName={'hello-world-101.docx'} />,
    sx: {
